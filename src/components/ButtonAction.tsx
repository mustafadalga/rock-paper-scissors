...
export default function ButtonAction() {
    ...
    const buttonClassName: string = `${isGamePending ? "text-burly-wood/25 bg-cod-gray/25 border-burly-wood/25" : "text-burly-wood bg-cod-gray border-burly-wood"} w-[10.25rem] h-10 md:h-12 lg:h-[4.5rem] border-2 border-solid rounded-[2rem] hover:shadow-[0px_0px_4px] hover:shadow-burly-wood transition-all duration-300`;
    ...
    return (
        <button type="button"
            ...
            <span className="uppercase text-base md:text-lg lg:text-xl">{buttonText}</span>
        </button>
    )
}